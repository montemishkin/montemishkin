...
export default class DjangoLogo extends Component {
    static propTypes = {
    ...
    render() {
        ...
        return (
            <svg {...unusedProps} viewBox='0 0 436.505 152.503'>
                <path
                    fill={color}
                    d={`
                        M51.464,0h23.872v110.496c-12.246,2.325-21.237,3.255-31.002,3.255C15.191,113.75,0,100.576,0,75.308
                ...
                <path
                    fill={color}
                    d={`
                        M113.312,36.865v55.338c0,19.067-1.395,28.212-5.58,36.118c-3.876,7.597-8.992,12.401-19.532,17.672
                ...
                <path
                    fill={color}
                    d={`
                        M127.731,42.29c10.542-4.959,20.617-7.129,31.623-7.129c12.246,0,20.306,3.254,23.872,9.61
                ...
                <path
                    fill={color}
                    d={`
                        M197.487,40.585c14.105-3.72,25.731-5.424,37.512-5.424c12.246,0,21.082,2.789,26.354,8.215
                ...
                <path
                    fill={color}
                    d={`
                        M277.142,125.842c8.372,4.34,16.742,6.354,25.577,6.354c15.655,0,22.321-6.354,22.321-21.546
                ...
                <path
                    fill={color}
                    d={`
                        M398.062,34.85c23.871,0,38.443,15.037,38.443,39.373c0,24.958-15.19,40.614-39.373,40.614
